...
class FacultyModel extends PageHelper
{
    public function listBookType()
    {
        ...
        $query = "SELECT `id`, `type_name`, `type_en_US` FROM `teacher_book_type`";
    ...
    public function listBookByTeacherIdAndTypeId($teacherId, $typeId)
    {
        ...
        $param[] = $typeId;
        $param[] = $teacherId;
        $query = "SELECT B.`title`, B.`id`, B.`url`, BT.`type_en_US` ";
    ...
    public function listTitle()
    {
        ...
        $query = "SELECT `id`, `title_name`, `en_US` ";
    ...
    public function listProfileType()
    {
        ...
        $query = "SELECT `id`, `type_name`, `type_en_US` FROM `teacher_profile_type`";
    ...
    public function getTeacherById($id)
    {
        ...
        $param[] = $id;
        $query = "SELECT U.`name`, TN.`title_name`, TN.`en_US`, U.`avatar`, U.`email`, T.`id`, T.`lab_location`, T.`teach_class`, ";
