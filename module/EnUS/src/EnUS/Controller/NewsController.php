...
class NewsController extends AbstractActionController
{
    public function detailAction()
    {
        ...
        $viewModel->setVariable("articleTypes", $articleModel->listType($languageModel->getLanguageIdByShortCut("en_US")));
    ...
    public function indexAction()
    {
        ...
        $languageId = $languageModel->getLanguageIdByShortCut("en_US");
